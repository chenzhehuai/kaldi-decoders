...
for dec_conf in conf/otf.2d.b.conf conf/otf.2d.c.conf conf/otf.2d.d.conf conf/otf.2d.e.conf #conf/otf.2c.b.conf conf/otf.2c.a.conf conf/otf.2c.c.conf conf/otf.2c.d.conf
do
