...
#false && \
{
      ...
      steps/nnet3/decode.otf.sh \
          ...
          --amsplit true \
          $tree_dir/graph_tgsmall/ data/${data}_hires ${dir}/decode_tgsmall_${data}.amsp2.`basename $otflang``basename $decgraph` \
          || exit 1
      }
#false && \
{
...
false && \
    {
for dec_conf in conf/otf.3b.a.conf #conf/otf.3a.conf #conf/otf.1b.conf 
do
    for otf_mode in 3 #2
    do
    {
