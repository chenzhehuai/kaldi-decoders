...
fstdeterminize ${dir}/det.HaCL.fst > $dir/tmp.fst
    fstrmsymbols ${dir}/h.disambig.int $dir/tmp.fst | \
    fstrmepslocal | \
    fstpushspecial \
 > $dir/HCLa.fst

    fstminimizeencoded $dir/HCLa.fst  \
